requirejs.config({
    ...
    paths: {
        ...
        'laydate':'libs/laydate/1.1.0/laydate',
        ...
        'colpick':'libs/colpick/1.0.0/colpick',
        'ueditor':'libs/ueditor/1.4.3.3/ueditor.all.min',
        'ueditor.config':'libs/ueditor/1.4.3.3/ueditor.config',
        'ueditor.zeroclipboard':'libs/ueditor/1.4.3.3/third-party/zeroclipboard/ZeroClipboard',
    ...
    shim:{
        ...
        'jquery.md5':['jquery'],
        'colpick':['jquery'],
        'ueditor':['ueditor.config', 'ueditor.zeroclipboard'],
        'flot':['jquery'],
